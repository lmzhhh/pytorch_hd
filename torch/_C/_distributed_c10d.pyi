...
def _register_comm_hook_4Elastic(reducer: ElasticReducer, state: Any, comm_hook: Any): ...
def _register_builtin_comm_hook(reducer: Reducer, comm_hook_type: BuiltinCommHookType): ...
def _register_builtin_comm_hook_4Elastic(reducer: ElasticReducer, comm_hook_type: BuiltinCommHookType): ...
